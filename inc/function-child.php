...
function velocitychild_theme_setup()
{
    ...
    if (class_exists('Kirki')) :
        ...
        Kirki::add_panel('panel_toko25', [
            'priority'    => 10,
            'title'       => esc_html__('Toko 25', 'justg'),
...
add_action('justg_header', 'justg_header_toko25');
function justg_header_toko25()
{
    require_once(get_stylesheet_directory() . '/inc/part-header.php');
}
add_action('justg_do_footer', 'justg_footer_toko25');
function justg_footer_toko25()
{
...
add_action('velocitytoko_product_loop', 'velocitytoko25_content_product', 30);
function velocitytoko25_content_product($post)
{
    if (is_singular('product')) :
        $class = 'col-6 mb-2';
    else :
